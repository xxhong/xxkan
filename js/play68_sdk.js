(function () {
    ...
    g.prototype = {
        ...
        refresh: function () {
            this.postData({op_type: "fn", value: {fn: "refresh", args: []}})
        },
        goHome: function (a) {
            this.postData({op_type: "fn", value: {fn: "go_home", args: [{url: a}]}})
        },
        setShareInfo: function (a, b, c) {
            this.postData({op_type: "fn", value: {fn: "setShareInfo", args: [{title: a, desc: b, showShareTime: c}]}})
        },
        shareFriend: function () {
            this.postData({op_type: "fn", value: {fn: "share", args: []}})
        },
        ...
        setRanking: function (a, b, c, e) {
            ...
            this.postData({
                op_type: "fn",
                value: {fn: "ranking", args: [{type: a, level: b || 0, score: c || 0, showRankingType: e}]}
            })
        },
        ...
        showRanking: function () {
            this.postData({op_type: "fn", value: {fn: "showRanking", args: []}})
        },
        closeRecommend: function () {
            this.postData({op_type: "fn", value: {fn: "closeRecommend", args: []}})
        },
        festivalgame: function () {
            this.postData({op_type: "fn", value: {fn: "festivalgame", args: []}})
        },
        setCrazycaitu: function (a, b) {
            this.postData({op_type: "fn", value: {fn: "setCrazycaitu", args: [{id: a, linkid: b}]}})
        },
        set_share_icon: function (a) {
            this.postData({op_type: "fn", value: {fn: "set_share_icon", args: [{share_icon: a}]}})
        },
        set_share_url: function (a) {
            this.postData({op_type: "fn", value: {fn: "set_share_url", args: [{share_url: a}]}})
        },
        getCrazycaitu: function () {
            this.postData({op_type: "fn", value: {fn: "getCrazycaitu", args: []}})
        },
        resetView: function () {
            this.postData({op_type: "fn", value: {fn: "resetView", args: []}})
        },
        resetFrame: function () {
            this.postData({op_type: "fn", value: {fn: "resetFrame", args: []}})
        },
        putLocalStorage: function (a, b) {
            this.postData({op_type: "fn", value: {fn: "putLocalStorage", args: [{kvVal: a, keys: b}]}})
        },
        pay: function (a, b, c, e) {
            this.postData({op_type: "fn", value: {fn: "pay", args: [{itemid: a, itemname: b, price: c, count: e}]}})
        },
        apilogin: function () {
            this.postData({op_type: "fn", value: {fn: "apilogin", args: []}})
        },
        __paysucc: null,
        onpaysucc: function (a) {
            if ("function" ===
                typeof a) this.__paysucc = a; else throw"onpaysucc\u53c2\u6570\u9519\u8bef\uff0c\u5fc5\u987b\u662f\u4e00\u4e2afunction\u3002";
        },
